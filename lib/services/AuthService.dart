...
class AuthService {
  Future signInWithGoogle() async {
    final GoogleSignInAccount? googleSignInAccount =
        await googleSignIn.signIn().catchError(log);
  ...
  Future<void> signUpWithEmailPassword(
    ...
    if (userCredential != null && userCredential.user != null) {
      ...
      userModel.userStatus = "Hey there! i am using IJ Chat";
  ...
  Future<void> signInWithEmailPassword(
    ...
    await _auth
      ...
      loginStore.setIsEmailLogin(aIsEmailLogin: true);
      loginStore.setMobileNumber(
          aMobileNumber: userModel.phoneNumber.validate());
