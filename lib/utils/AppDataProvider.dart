...
List<PopupMenuItem> dashboardPopUpMenuItem = [
  PopupMenuItem(
      ...
      child: Observer(
          builder: (_) =>
              Text('new_chat'.translate, style: primaryTextStyle()))),
  PopupMenuItem(
      value: 2,
      child: Observer(
          builder: (_) =>
              Text('settings'.translate, style: primaryTextStyle()))),
];
...
List<PopupMenuItem> chatScreenPopUpMenuItem = [
  PopupMenuItem(
      ...
      child: Observer(
          builder: (_) =>
              Text('view_Contact'.translate, style: primaryTextStyle()))),
  // PopupMenuItem(
  //     value: 2,
  //     child: Observer(
  //         builder: (_) => Text('report'.translate, style: primaryTextStyle()))),
  // PopupMenuItem(
  //     value: 3,
  //     child: Observer(
  //         builder: (_) => Text('block'.translate, style: primaryTextStyle()))),
  PopupMenuItem(
      value: 4,
      child: Observer(
          builder: (_) =>
              Text('clear_Chat'.translate, style: primaryTextStyle()))),
];
...
List<PopupMenuItem> chatLogPopUpMenuItem = [
  PopupMenuItem(
      ...
      child: Observer(
          builder: (_) =>
              Text('clear_Call_Logs'.translate, style: primaryTextStyle()))),
];
