  ...
  void signUpWithOtp() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (await userService.isUserExist(emailCont.text)) {
        ...
        userModel.userStatus = "Hey there! i am using Green Chat";
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              8.height,
              Text('sign_up_to_continue'.translate,
              ...
              AppTextField(
                ...
                decoration:
                    inputDecoration(context, labelText: "name".translate),
              ),
              16.height,
              AppTextField(
                focus: emailFocus,
              ...
              AppTextField(
                ...
                decoration:
                    inputDecoration(context, labelText: "password".translate),
