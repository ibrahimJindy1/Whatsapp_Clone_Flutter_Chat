              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Image.asset("assets/app_icon.png",
                            height: 25, width: 25),
                        6.width,
                        Text('Green Chat Video call'.toUpperCase(),
                    ...
                    16.height,
                    Text(widget.callModel!.callerName.validate(),
                        style: primaryTextStyle(color: Colors.white, size: 25)),
                    20.height,
                    Text('Incoming'.toUpperCase(),
